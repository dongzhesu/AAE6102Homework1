...
%% Apply Extended Kalman Filter for improved positioning ==================
    disp('   Applying Extended Kalman Filter for improved positioning...');
    
    % Call the EKF function with pseudo-ranges and satellite positions
    % This function will estimate position using the EKF algorithm
    ekfSolutions = applyEKF(navSolutions, trackResults, settings, eph);
    
    disp('   EKF processing completed');
...
%% Plot all results =======================================================
    ...
    % Plot EKF results alongside least squares results for comparison
